# VAT Identidier Discovery Pipeline
...
### The "Ghost Company" Problem: 
 I drew a purely random sample from the Companies House bulk data.
...
### The JavaScript Problems: 
  Then I pointed my scraper at the homepages of target companies.
